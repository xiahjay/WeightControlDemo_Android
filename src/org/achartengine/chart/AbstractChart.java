...
public abstract class AbstractChart implements Serializable {
   ...
   * @param titles the titles to go to the legend 系列的标题
   ...
   * @param calculate if only calculating the legend size 是否只计算图例、说明的大小
   * 
   ...
   * @param extraHeight the added extra height 添加额外的高度
